...
def evaluate_instance(
    ...
    logger.info(f"=== Evaluating Conflict_Resolution Instance {instance_idx} (RAPTOR) ===")
    ...
    # Initialize Memory (Load RAPTOR tree)
    tree_path = Path(tree_dir) / f"raptor_conflict_{instance_idx}.pkl"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Conflict_Resolution (RAPTOR)")
